...
const scores = [
    ...
    new Score("Beautiful Things", "Various", "Gitár", "Pop", "Kezdő", "G major", 145.88, 1, "IKT_kották/Gitár/Pop/Kezdő/Képek/Beautiful_things/Beautiful_things.jpg"),
    ...
    new Score("Bohemian Rhapsody", "Queen", "Hegedű", "Rock", "Közép", "Bbm", 101.47, 1, "IKT_kották/Hegedű/Rock/Középhaladó/Képek/Bohemian_Rhapsody/Bohemian_Rhapsody.jpg"),
    new Score("Boogie Woogie Stomp", "Various", "Zongora", "Jazz", "Kezdő", "Bb major", 55.68, 1, "IKT_kották/Zongora/Jazz/Kezdő/Képek/Boogie_Woogie_Stomp/Boogie_Woogie_Stomp.jpg"),
    ...
    new Score("Bye Bye Blackbird", "Various", "Hegedű", "Jazz", "Haladó", "F major", 114.05, 1, "IKT_kották/Hegedű/Jazz/Haladó/Képek/bye_bye_blackbird/bye_bye_blackbird.jpg"),
    new Score("Canon In D", "Pachelbel", "Hegedű", "Klasszikus", "Kezdő", "D major", 93.74, 1, "IKT_kották/Hegedű/Klasszikus/Kezdő/Képek/Canon_in_D/Canon_in_D.jpg"),
    new Score("Could Have Been Me", "Various", "Zongora", "Rock", "Haladó", "B major", 69.32, 1, "IKT_kották/Zongora/Rock/Haladó/Képek/Could_Have_Been_Me/Could_Have_Been_Me.jpg"),
    ...
    new Score("Defying Gravity", "Wicked", "Zongora", "Zenés színház", "Kezdő", "C major", 102.98, 1, "IKT_kották/Zongora/Zenés_színház/Kezdő/Képek/Defying_Gravity/Defying_Gravity.jpg"),
    new Score("Die With A Smile", "Lady Gaga", "Gitár", "Pop", "Haladó", "A major", 136.78, 1, "IKT_kották/Gitár/Pop/Haladó/Képek/Die_with_a_smile/Die_with_a_smile.jpg"),
    ...
    new Score("Fascination", "Various", "Gitár", "Klasszikus", "Közép", "D major", 83.94, 1, "IKT_kották/Gitár/Klasszikus/Középhaladó/Képek/Fascination/Fascination.jpg"),
    ...
    new Score("Gentlemen", "Ravel", "Zongora", "Klasszikus", "Haladó", "G major", 74.87, 1, "IKT_kották/Zongora/Klasszikus/Haladó/Képek/Goodness_Of_God/Goodness_Of_God.jpg"),
    new Score("Geralt Of Rivia", "Various", "Gitár", "Zenés színház", "Haladó", "Am", 114.42, 1, "IKT_kották/Gitár/Zenés_színház/Haladó/Képek/Geralt_Of_Rivia/Geralt_Of_Rivia.jpg"),
    new Score("Ghostbusters", "Ray Parker Jr.", "Dob", "Zenés színház", "Közép", "Em", 90.67, 1, "IKT_kották/Dob/Zenés_színház/Középhaladó/Képek/Ghostbusters/Ghostbusters.png"),
    new Score("Girl From Ipanema", "Various", "Gitár", "Jazz", "Haladó", "G major", 161.85, 1, "IKT_kották/Gitár/Jazz/Haladó/Képek/The_girl_from_Ipanema/The_girl_from_Ipanema.jpg"),
    new Score("Girls Like You", "Various", "Hegedű", "Pop", "Kezdő", "F# major", 138.22, 1, "IKT_kották/Hegedű/Pop/Kezdő/Képek/Girls_like_you/Girls_like_you.jpg"),
    new Score("Golden", "Various", "Hegedű", "Zenés színház", "Kezdő", "F# major", 63.30, 1, "IKT_kották/Hegedű/Zenés_színház/Kezdő/Képek/Golden/Golden.jpg"),
    new Score("Grande Valse Brillante", "Chopin", "Gitár", "Klasszikus", "Haladó", "A major", 137.05, 1, "IKT_kották/Gitár/Klasszikus/Haladó/Képek/Grande_valse_brillante_Op.18/Grande_valse_brillante_Op.18.jpg"),
    ...
    new Score("He's A Pirate", "Various", "Fuvola", "Zenés színház", "Haladó", "G major", 146.03, 1, "IKT_kották/Fuvola/Zenés_színház/Haladó/Képek/Hes_a_pirate/Hes_a_pirate.jpg"),
    ...
    new Score("I Won't Say I'm In Love", "Disney", "Dob", "Zenés színház", "Kezdő", "D major", 109.63, 1, "IKT_kották/Dob/Zenés_színház/Kezdő/Képek/I_wont_say_(Im_in_love)/I_wont_say_(Im_in_love).jpg"),
    ...
    new Score("We Don't Talk About Bruno", "Encanto", "Hegedű", "Zenés színház", "Haladó", "C major", 47.07, 1, "IKT_kották/Hegedű/Zenés_színház/Haladó/Képek/We_dont_talk_about_Bruno/We_dont_talk_about_Bruno.jpg"),
